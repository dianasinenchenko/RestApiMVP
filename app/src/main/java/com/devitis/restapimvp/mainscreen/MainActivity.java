...
import com.devitis.restapimvp.App;
import com.devitis.restapimvp.R;
...
public class MainActivity extends AppCompatActivity implements IMainScreenContract.IView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DaggerIMainScreenComponent.builder()
                .netComponent(((App) getApplicationContext()).getiNetComponent())
                .mainScreenMoodule(new MainScreenModule(this))
                .build().inject(this);
